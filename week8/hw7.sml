...
fun eval_prog (e,env) =
    case e of
      ...
      | Shift (dx,dy,subexp) => let val subexp_val = eval_prog(subexp, env)
                                in case subexp_val of
                                       NoPoints => NoPoints
...
fun preprocess_prog e =
    case e of
      ...
      | Let (s,e1,e2) => let val preprocessed_e1 = preprocess_prog e1
                         ...
                         in 
                             Let (s, preprocessed_e1, preprocessed_e2)
                         end
      ...
      | Shift (dx,dy,subexp) => let val preprocessed_subexp = preprocess_prog subexp
                                in 
                                    Shift (dx, dy, preprocessed_subexp)
                                end
